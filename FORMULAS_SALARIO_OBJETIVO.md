...
Usa REM M+1 (col 3). `TRUE` = match aproximado: si el mes actual no está en REM, usa el reporte más reciente disponible.
```excel
=ARRAYFORMULA(IF(C3:C="","-",IFERROR(
  C3:C * (1+VLOOKUP(DATE(YEAR(B3:B),MONTH(B3:B),1),REM!$A$4:$I,3,TRUE)),
"-")))
```
...
=ARRAYFORMULA(IF(C3:C="","-",IFERROR(
  C3:C
  * (1+IFERROR(VLOOKUP(DATE(YEAR(B3:B),MONTH(B3:B),1),REM!$A$4:$I,3,TRUE),0))
  * (1+IFERROR(VLOOKUP(DATE(YEAR(B3:B),MONTH(B3:B),1),REM!$A$4:$I,4,TRUE),0))
  * (1+IFERROR(VLOOKUP(DATE(YEAR(B3:B),MONTH(B3:B),1),REM!$A$4:$I,5,TRUE),0)),
"-")))
```
...
=ARRAYFORMULA(IF(C3:C="","-",IFERROR(
  ...
  * (1+IFERROR(VLOOKUP(DATE(YEAR(B3:B),MONTH(B3:B),1),REM!$A$4:$I,4,TRUE),0))
  * (1+IFERROR(VLOOKUP(DATE(YEAR(B3:B),MONTH(B3:B),1),REM!$A$4:$I,5,TRUE),0))
  * (1+IFERROR(VLOOKUP(DATE(YEAR(B3:B),MONTH(B3:B),1),REM!$A$4:$I,6,TRUE),0))
  * (1+IFERROR(VLOOKUP(DATE(YEAR(B3:B),MONTH(B3:B),1),REM!$A$4:$I,7,TRUE),0))
  * (1+IFERROR(VLOOKUP(DATE(YEAR(B3:B),MONTH(B3:B),1),REM!$A$4:$I,8,TRUE),0)),
"-")))
```
...
```excel
=ARRAYFORMULA(IF(C3:C="","-",IFERROR(
  C3:C * (1+VLOOKUP(DATE(YEAR(B3:B),MONTH(B3:B),1),REM!$A$4:$I,9,TRUE)),
"-")))
```
