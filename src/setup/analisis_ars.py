"""Setup de la hoja Análisis ARS - Sueldo vs Inflación en pesos."""
...
def setup_analisis_ars(ss: gspread.Spreadsheet) -> None:
    """Configura la hoja de Análisis ARS.
    ...
    # Batch update de fórmulas (ahora solo una por columna en la fila 3)
    formula_updates = []
    for col_let, title, *rest in ANALISIS_ARS_COLUMNS:
