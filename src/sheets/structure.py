...
DASHBOARD_ROWS = [
    ...
    (3, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!K3:K, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!K3:K<>"")), ROWS(FILTER(\'Análisis ARS\'!K3:K, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!K3:K<>"")))), "")', None),
    ...
    (9, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!E3:E, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!E3:E<>"")), ROWS(FILTER(\'Análisis ARS\'!E3:E, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!E3:E<>"")))), "")', None),
    (9, "C", '=IF(B9="", "", B9*8*20)', None),
    (9, "D", "Bruto mensual (8hs)", None),
    (10, "A", "Neto/Hora ajustado por CER (debería ser)", None),
    (10, "B", '=LOOKUP(2, 1/((\'Análisis ARS\'!J3:J<>0)*(\'Análisis ARS\'!J3:J<>"")), \'Análisis ARS\'!J3:J)', None),
    ...
    (15, "B", '=B3', None),
    (15, "C", '=IF(B15="", "", IFERROR(INDEX(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")), ROWS(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>""))))/(1+B15)*8*20, ""))', None),
    (16, "A", "vs REM proyectado", None),
    (16, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!N3:N, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!N3:N<>"")), ROWS(FILTER(\'Análisis ARS\'!N3:N, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!N3:N<>"")))), "")', None),
    (16, "C", '=IF(B16="", "", IFERROR(INDEX(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")), ROWS(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>""))))/(1+B16)*8*20, ""))', None),
    (17, "A", "vs Inflación INDEC acumulada", None),
    (17, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!O3:O, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!O3:O<>"")), ROWS(FILTER(\'Análisis ARS\'!O3:O, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!O3:O<>"")))), "")', None),
    (17, "C", '=IF(B17="", "", IFERROR(INDEX(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")), ROWS(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>""))))/(1+B17)*8*20, ""))', None),
    (18, "A", "vs USD (CCL)", None),
    (18, "B", '=IFERROR(INDEX(FILTER(\'Análisis USD\'!Q3:Q, (\'Análisis USD\'!B3:B<>"") * (\'Análisis USD\'!Q3:Q<>"")), ROWS(FILTER(\'Análisis USD\'!Q3:Q, (\'Análisis USD\'!B3:B<>"") * (\'Análisis USD\'!Q3:Q<>"")))), "")', None),
    (18, "C", '=IF(B18="", "", IFERROR(INDEX(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")), ROWS(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>""))))/(1+B18)*8*20, ""))', None),

    # ÚLTIMO MES (rows 20-25)
    (20, "A", "Métrica", None),
    (20, "B", "Valor", None),
    (21, "A", "CER Mensual (%)", None),
    (21, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!P3:P, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!P3:P<>"")), ROWS(FILTER(\'Análisis ARS\'!P3:P, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!P3:P<>"")))), "")', None),
    (22, "A", "Índice CER Actual", None),
    (22, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!R3:R, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!R3:R<>"")), ROWS(FILTER(\'Análisis ARS\'!R3:R, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!R3:R<>"")))), "")', None),
    (23, "A", "Cambio $/Hora vs CER Acum", None),
    (23, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!Q3:Q, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!Q3:Q<>"")), ROWS(FILTER(\'Análisis ARS\'!Q3:Q, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!Q3:Q<>"")))), "")', None),
    (24, "A", "Índice CER Base", None),
    (24, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!S3:S, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!S3:S<>"")), ROWS(FILTER(\'Análisis ARS\'!S3:S, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!S3:S<>"")))), "")', None),
    (25, "A", "Tendencia últimos 3 meses", None),
    (25, "B", '=IFERROR(LET(datos, FILTER(\'Análisis ARS\'!K3:K, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!K3:K<>"")), n, ROWS(datos), IF(n<3, "", INDEX(datos, n) - INDEX(datos, MAX(1, n-3)))), "")', None),
    ...
    (28, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!T3:T, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!T3:T<>"")), ROWS(FILTER(\'Análisis ARS\'!T3:T, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!T3:T<>"")))), "")', None),
    (29, "A", "Objetivo REM 6 meses", None),
    (29, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!W3:W, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!W3:W<>"")), ROWS(FILTER(\'Análisis ARS\'!W3:W, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!W3:W<>"")))), "")', None),
    (30, "A", "Nuevo sueldo objetivo (Bruto 8hs CER)", None),
    (30, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!I3:I, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!I3:I<>"")), ROWS(FILTER(\'Análisis ARS\'!I3:I, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!I3:I<>""))))*8*20, "")', None),
    ...
    (33, "C", '=LET(bruto_mensual, INDEX(FILTER(\'Análisis ARS\'!D:D, (\'Análisis ARS\'!B:B<>"") * (\'Análisis ARS\'!D:D<>"")), ROWS(FILTER(\'Análisis ARS\'!D:D, (\'Análisis ARS\'!B:B<>"") * (\'Análisis ARS\'!D:D<>""))))*8*20, IF(B33="", "", IF(B33>2*bruto_mensual, "🔴", IF(B33>bruto_mensual, "🟡", "🟢"))))', None),
    ...
    (41, "B", '=IFERROR(MIN(FILTER(\'Análisis ARS\'!K3:K, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!K3:K<>""))), "")', None),
    (41, "C", '=IF(B41="", "", IFERROR(INDEX(FILTER(\'Análisis ARS\'!B3:B, (\'Análisis ARS\'!K3:K = B41)), 1), ""))', None),
    (41, "D", "Fecha peor momento", None),
    (42, "A", "Mejor momento vs CER (histórico)", None),
    (42, "B", '=IFERROR(MAX(FILTER(\'Análisis ARS\'!K3:K, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!K3:K<>""))), "")', None),
    (42, "C", '=IF(B42="", "", IFERROR(INDEX(FILTER(\'Análisis ARS\'!B3:B, (\'Análisis ARS\'!K3:K = B42)), 1), ""))', None),
    ...
    (47, "B", '=IFERROR(MAX(FILTER(\'Análisis ARS\'!E3:E, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!E3:E<>""))), "")', None),
    (47, "C", '=IFERROR(MAX(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")))*8*20, "")', None),
    (47, "D", "Bruto mensual nominal", None),
    (48, "A", "Máximo histórico ajustado por CER", None),
    (48, "B", '=IFERROR(MAX(FILTER(\'Análisis ARS\'!J3:J, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!J3:J<>""))), "")', None),
    (48, "C", '=IFERROR(MAX(FILTER(\'Análisis ARS\'!I3:I, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!I3:I<>"")))*8*20, "")', None),
    ...
    (51, "C", '=IF(OR(B51="", B9=""), "", IFERROR(INDEX(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")), ROWS(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")))) * (1+B51) * 8 * 20, ""))', None),
    (51, "D", "Bruto mensual (8hs)", None),
    (52, "A", "Aumento para estar +20% sobre CER", None),
    (52, "B", '=IF(B3="", "", (1.2/(1+B3))-1)', None),
    (52, "C", '=IF(OR(B52="", B9=""), "", IFERROR(INDEX(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")), ROWS(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")))) * (1+B52) * 8 * 20, ""))', None),
    ...
    (55, "B", '=IFERROR(MAX(FILTER(\'Análisis ARS\'!I3:I, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!I3:I<>""))), "")', None),
    (55, "C", '=IF(B55="", "", IFERROR(INDEX(FILTER(\'Análisis ARS\'!B3:B, (\'Análisis ARS\'!I3:I = B55)), 1), ""))', None),
    (55, "D", "Fecha de ese pico", None),
    (56, "A", "Brecha vs mejor momento histórico (ajustado por CER)", None),
    (56, "B", '=IFERROR(INDEX(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")), ROWS(FILTER(\'Análisis ARS\'!D3:D, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!D3:D<>"")))) - B55, "")', None),
    ...
    (62, "B", '=IF(B59="", "", IF(B59="🚨 CRÍTICO", "Negociar aumento URGENTE", IF(B59="🔴 ALTO", "Solicitar reunión pronto", IF(B59="🟡 MEDIO", "Monitorear y preparar", "Solicitar revisión"))))', None),

    # VISUALIZACIÓN TENDENCIA (columnas E-H, rows 2-12)
    (2, "E", "TENDENCIA PODER ADQUISITIVO", None),
    (3, "E", "Últimos 12 meses", None),
    (3, "F", '=SPARKLINE(FILTER(\'Análisis ARS\'!K3:K, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!K3:K<>"")), {"charttype", "line"; "color1", "red"; "linewidth", 2})', None),
    (5, "E", "Evolución Neto/Hora", None),
    (5, "F", '=SPARKLINE(FILTER(\'Análisis ARS\'!E3:E, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!E3:E<>"")), {"charttype", "line"; "color1", "blue"; "linewidth", 2})', None),
    (7, "E", "CER mensual", None),
    (7, "F", '=SPARKLINE(FILTER(\'Análisis ARS\'!P3:P, (\'Análisis ARS\'!B3:B<>"") * (\'Análisis ARS\'!P3:P<>"")), {"charttype", "column"; "color1", "orange"})', None),
