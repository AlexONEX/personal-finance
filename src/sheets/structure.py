...
INCOME_COLUMNS = [
    ...
    (
        "V",
        "Δ Real vs Año Ant.",
        '=IFERROR((L{r} / VLOOKUP(EDATE(A{r},-12), $A:$L, 12, FALSE)) / (VLOOKUP(A{r}, historic_data!$A$4:$B, 2, TRUE) / VLOOKUP(EDATE(A{r},-12), historic_data!$A$4:$B, 2, TRUE)) - 1, "")',
    ),
...
COLUMN_DESCRIPTIONS = {
    ...
    "V": "Crecimiento real interanual móvil",
